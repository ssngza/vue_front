...
export default {
 ...
 methods: {
    warehouseClick(payload) {
      console.log('warehouseClick')
      this.warehouseCode = payload.warehouseCode
      this.$store.dispatch('logi/stock/SEARCH_STOCK_DETAIL_LIST', payload)    },
  },
}
</script>
...
<template>
  ...
  &lt;!&ndash; Table Container Card &ndash;&gt;
  <b-card id="scrollStyle" no-body style="font-family: '배달의민족 도현'; overflow-x: scroll; max-height: 500px">
    <div class="m-2">
...
export default {
  components: {BCard, BRow, BCol, BFormInput, BButton, BTable, BMedia, BAvatar, BLink, BBadge, BDropdown, BDropdownItem, BPagination, BTooltip, BFormDatepicker, BInputGroup, BInputGroupAppend, vSelect,},
  computed: {
    ...mapState({
